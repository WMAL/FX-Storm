...
Begin VB.Form Form1 
   Appearance      =   0  'Flat
   BackColor       =   &H00E0E0E0&
   Caption         =   "Pivot Signals : By Dr Jeeni"
   ClientHeight    =   10605
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8700
...
Private Sub Form_Load()
   ...
   ' Combo1.AddItem "CHF/JPY" '10
    ...
    'creat columns
    'for list cloumns
    ListView1.ColumnHeaders.Add , , "Date", ListView1.Width / 9 + 110
    ListView1.ColumnHeaders.Add , , "Time", (ListView1.Width / 9) + 110
    ListView1.ColumnHeaders.Add , , "Pair", ListView1.Width / 9 + 240
    ListView1.ColumnHeaders.Add , , "Entry", ListView1.Width / 9 - 20
    ListView1.ColumnHeaders.Add , , "Actual", ListView1.Width / 9 - 20
    'ListView1.ColumnHeaders.Add , , "T/P", ListView1.Width / 11 - 20
    'ListView1.ColumnHeaders.Add , , "S/L", ListView1.Width / 11 - 20
    ListView1.ColumnHeaders.Add , , "Ex Price", ListView1.Width / 9 - 20
    ListView1.ColumnHeaders.Add , , "Delay", ListView1.Width / 9 - 160
    ListView1.ColumnHeaders.Add , , "Deal", ListView1.Width / 9 - 40
    ListView1.ColumnHeaders.Add , , "level", ListView1.Width / 9 - 150
    ...
    End If
      ...
      If Check2.Value = 1 Then
            ctxSysTray1.AddIconToSystray "Pivot Signals " & theversion
...
Public Sub opstart()
 ...
 If lvButtons_H1.Caption = "Start" Then
        ...
        Me.Caption = "Pivot Signals" & " " & Combo1.Text & " " & Combo2.Text
...
Private Sub lvButtons_H4_Click()
    ...
    Open App.Path & "\" & thesplit(0) & thesplit(1) & "-History.csv" For Output As #21
         Print #21, "Date" & "," & "Time" & "," & "Pair" & "," & "Entry" & "," & "Actual" & "," & "Ex price" & "," & "Delay" & "," & "Deal" & "," & "Level"
             
         For xcounter = 1 To Form1.ListView1.ListItems.count
            Set Litem = ListView1.ListItems.Item(xcounter)
            Print #21, ListView1.ListItems.Item(xcounter) & "," & Litem.ListSubItems.Item(1) & "," & Litem.ListSubItems.Item(2) & "," & Litem.ListSubItems.Item(3) & "," & Litem.ListSubItems.Item(4) & "," & Litem.ListSubItems.Item(5) & "," & Litem.ListSubItems.Item(6) & "," & Litem.ListSubItems.Item(7) & "," & Litem.ListSubItems.Item(8)
...
Private Sub lvButtons_H5_Click()
    ...
    Open App.Path & "\" & thesplit(0) & thesplit(1) & "-History.csv" For Append As #21
         'Print #21, "Date" & "," & "Time" & "," & "Pair" & "," & "Entry" & "," & "Actual" & "," & "Ex price" & "," & "Delay" & "," & "Deal" & "," & "Level"
   ...
   On Error GoTo thend
        ...
        If hourcounter = Combo2.Text Then
            ...
            If thebuy = 1 And thesell = 0 Then
                ...
                Me.Caption = "Pivot Trader" & " " & Combo1.Text & " " & Combo2.Text & " buy"
                If Check2.Value = 1 Then
            ...
            If thebuy = 0 And thesell = 1 Then
                ...
                Me.Caption = "Pivot Trader" & " " & Combo1.Text & " " & Combo2.Text & " sell"
                If Check2.Value = 1 Then
         ...
         End If
             ...
             If thebuy = 1 Then
              ...
              Else
                ...
                Litem.ListSubItems.Add , , temppp
                Call LVW_ModifyLine(ListView1, ListView1.ListItems.count, True, vbRed, "Won", False, False)
              ...
              End If
                ...
                Label12.Caption = "Total:" & Form1.ListView1.ListItems.count
